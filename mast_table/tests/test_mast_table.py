...
def test_dataset_table_init(mast_observation_table):
    mast_table = Datasets(mast_observation_table)
...
def test_product_table_init(mast_observation_table):
    mast_table = Products(mast_observation_table)
